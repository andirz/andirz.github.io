{% comment %}
  Skill List Configuration - Updated February 2026
  Includes EP17 (Life & Death) through EP21 (Royalty & Legacy)
  Format: slug|Name|Age|PackID|PackName|InternalID|MaxLevel
{% endcomment %}
...
<style>
  ...
  .skills-table th { background-color: #f4f4f4; }
