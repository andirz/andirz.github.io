...
* **[Discord Community]({{ site.data.globals.links.discord }})** – Get quick help from me and other players.
* **[Patreon]({{ site.data.globals.links.patreon }})** – For detailed bug reports and priority support.
