...
categories: [Purchasing System, Core]
strings: false
---
...
## Important Update
Starting with version 2.0, the internal custom script has been completely removed to avoid conflicts with other mods and frameworks. The P.S.O. Common Package now relies entirely on the **Smart Core Script** for all technical functionality. The Smart Core Script must be installed separately and serves as the underlying system that handles advanced logic not supported by the base game.
