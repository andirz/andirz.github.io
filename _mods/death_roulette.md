...
The following Sims can participate:
...
- Skeletons  
- Grim Reaper  
- Toddlers (immortal by game design)

Special cases:
- Pregnant Sims can be selected, but if they die, the pregnancy is removed (EA limitation).
- Immortal Sims can be selected; if fate decides death, the immortal trait is removed.
